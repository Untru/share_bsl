...
// примеры пути
// Когда есть форма
// _bsl\Resources\726598511\Catalog\Контрагенты\CatalogForm\ФормаЭлемента\CatalogForm.obj.bsl
// Остальные
// _bsl\Resources\726598511\Catalog\Номенклатура\Catalog.mgr.bsl
