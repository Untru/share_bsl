...
Публикатор : Опубликовать()
МенеджерПубликаций : ОбработатьФайл()
Команда1_Сообщение : ПодходитПоУсловию(Сообщение)
Команда1_Сообщение : Обработать(Сообщение)
Команда2_Файл : ПодходитПоУсловию(Сообщение)
Команда2_Файл : Обработать(Сообщение)

```

![Изменение модели](https://img.plantuml.biz/plantuml/svg/hLBBIiDG4Dq7yWztMHTTwDA52AxzXX9gS64qaiIL5c95GH2Bu4h4-lg0L1jDcpRzXJD_vDnhnCGcUWikalkOC-VCp3thVc1vmS6kOnfjn_9ziU7k1PxhEBRtTRFfRjaSthVQEzQsNG28GzCGuXE4AsJKnIDYfFozKeW84qmAY1jaV1DXYY6YvHOU-9nXGEUCdo91N8TTQU6PzoEafb6d8rO5-dp8y8AOruIwTF5JWdgD9TFeI9tlVbHxfLPk5JfcwJV5rQSJ35WkmHWHdV4wAg2l6JbMvSuuabAFoyieB23A-NcqyqilpURHcjQy5c4eJR4cakTf3K07bVFLZcW1ZieXrZ5BDznpI-zgOA5CO3VaJKeFLD79f3lC2W5f9fMgKdHgLHHAaKFoQUQL_tnMPMM-6jAf_4ihg_CJ7REQh2cXoyPydZPvHOKwT0MR_5U5PKhDkZu0)
...
Так же внимательный читатель увидел аннотацию &Число - это тоже одна из фишек  фреймворка Осени, типизиторать переменные.