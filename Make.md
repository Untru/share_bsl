...
У метода ПриСозданииОбъекта() установили аннотацию &Желудь, так мы указали, что этот класс мы можем получить в любой момент из Контейнера, создаваемого Осенью, например как мы сделали в классе Запускатор. При инициализации приложения и обращении к классу.
А когда мы пишем &Пластилин - мы получаем экземпляр нашего объекта.
&Число - можем указать тип данных, это тоже возможности фреймворка Осень.
