...
Для того, что бы мне разбирать файлы, я создал 2 папки, куда буду класть исходники и куда все буду распаковывать
![alt text](images/image-11.png)

Давайте подумаем, с какими сложнгостями мы можем столкнуться?
