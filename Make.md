...
Приветствую всех! Меня зовуит Чегодаев Павел, и я хочу вместе с вами пройти мастер класс.
На написание этой статьи, меня вдохновила эта публикация [Мастер класс по созданию приложения](https://infostart.ru/1c/articles/2275659/), считаю, что автор большой молодец. Статья была написанна давно, а второй части с Осенью нет, по этому я возьму на себя смелость с вами пройти мастер класс уже на осени.
...
Как мы все знаем, лучший код писался во времена УТ 10 с километровыми методами которые длали сразу все. Но мы назло всем так делать не будем. Паттернов и подходов к разработке приложений много, но давайте возьмем за основу **MVC**.
...
### Установка OneScript и фреймворка Осень

Сначала нам нужно установить OneScript и фреймворк Осень. Создадим файл конфигурации:
